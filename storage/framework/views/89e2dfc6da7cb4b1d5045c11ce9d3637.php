                ...
                <div class="slider">
                    <div class="slider-content">
                        ...
                        <div class="image-container">
                            <img src="<?php echo e(asset('img/bg-img/org2.png')); ?>" alt="Mushroom Image" class="slider-image active" id="image1">
                            <img src="<?php echo e(asset('img/bg-img/now.png')); ?>" alt="Mushroom Image" class="slider-image" id="image2">
                            <img src="<?php echo e(asset('img/bg-img/tgn.png')); ?>" alt="Mushroom Image" class="slider-image" id="image3">
                        ...
                        <div class="text-content">
                            ...
                            <div class="button-container">
                                <a href="#download" class="btn alazea-btn">DOWNLOAD NOW!</a>
                                <a href="<?php echo e(route('signin.form')); ?>" class="btn alazea-btn">SIGN IN</a>
                            </div>
                        </div>
    ...
    <section id="feature" class="features-section">
        ...
        <div class="features-container">
            ...
            <div class="feature-image">
                <img src="<?php echo e(asset('img/bg-img/hpp.png')); ?>" alt="Phone Mockup">
            </div>
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-12 col-md-6">
                    <div class="contact--thumbnail">
                        <img src="<?php echo e(asset('img/bg-img/hp1.png')); ?>" alt="">
                    </div>
                </div>
                ...
                <div class="col-12 col-md-5">
                    ...
                    <a href="https://www.apple.com/id/app-store/" target="_blank">
                        <input type="image" src="<?php echo e(asset('img/bg-img/gplay.png')); ?>" alt="Teks Alt" class="image-button" />
                    </a>
                      
                    <a href="https://play.google.com/store" target="_blank">
                        <input type="image" src="<?php echo e(asset('img/bg-img/gpla.png')); ?>" alt="Teks Alt" class="image-button" />
                    </a>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\Users\lunaf\mushroom4-app\resources\views/home/home.blade.php ENDPATH**/ ?>