  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
                <a href="index-admin.html" class="menu-link" id="dashboard-link">
        ...
        <li class="menu-item">
            <a href="notip.html" class="menu-link">
         ...
         <!-- Rate menu item -->
         <li class="menu-item">
            <a href="rate.html" class="menu-link">
        ...
        <!-- order menu item -->
        <li class="menu-item">
            <a href="order.html" class="menu-link menu-toggle">
        ...
        <div class="account-center">
            ...
            <a href="login.html" class="btn btn-primary w-100 text-center">LOGOUT</a>
          </div>
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end" id="notificationDropdown">
                ...
                <li>
                    <a class="dropdown-item text-center text-primary" href="notif.html">
  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      <div class="d-flex flex-wrap gap-4">
        <a href="product.html" class="btn btn-primary">Manage Products</a>
        <a href="order.html" class="btn btn-primary">Manage Orders</a>
        <a href="rate.html" class="btn btn-primary">Manage Ratings</a>
        <a href="notip.html" class="btn btn-primary">Notifications</a>
      </div>
    </div>
  </div>
</div>
...
<body>
    ...
    <p>You are logged in as <?php echo e(Auth::user()->username); ?></p>
...
<?php /**PATH C:\Users\lunaf\mushroom4-app\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>